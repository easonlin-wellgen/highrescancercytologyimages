...
I. Brief Description
	...
	The datasets contain two file folders:
	Positive: images contain cancer and atypical cells
	Negative: images contain normal cells (no cancer cells)
	
	All images were examined and reviewed by two cytopathologists to validate their accuracy and consistency. 
...
III. Image Data Information
	To address the objective, we employed a commercial microscope system (CytoScan, Wellgen Medical, Kaohsiung, USFDA listing 2024) as the slide scanner capable of capturing high-resolution images at 450x or 900x magnification. This proprietary inverted microscope system was originally designed for sputum smears to detect acid-fast TB bacillus. The imaging system allows for the acquisition of detailed cytological images using filed-by-field autofocus that surpasses the capabilities of traditional slide scanners. In this study, we used 450x as our magnification power for all case smears. Each field of view was captured at 1,928 x 1,208 (pixel) image resolution at a physical size of 565 x 354 um2 (each pixel is 0.293 x 0.293 um2).
...
V. Customer Service and Contact
	If you have any questions on the dataset, please get in touch with service@wellgenmed.com. Or, if you wish to have more images for academic, research and/or commercial use, please contact service@wellgenmed.com as well.
